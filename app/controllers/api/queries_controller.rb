module Api
  class QueriesController  < ApplicationController
    ...
    def show
      ...
      log_api_call "View quality measure calculation"
      authorize! :read, @qr
      render json: @qr
    end
    ...
    def create
      ...
      log_api_call "Create a clinical quality calculation"
      render json: qr
    end
    ...
    def destroy
      ...
      authorize! :delete, qr
      qr.destroy
      log_api_call "Remove clinical quality calculation"
    ...
    def recalculate
      ...
      log_api_call "Force a clinical quality calculation"
      render json: qr
    end
    ...
    def patient_results
      ...
      log_api_call "Get patient results for measure calculation", true
    ...
    def patients
      ...
      log_api_call "Get patients for measure calculation", true

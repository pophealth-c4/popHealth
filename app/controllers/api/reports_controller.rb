module Api
  ...
  class ReportsController < ApplicationController
    ...
    CDESC
    def cat3
      log_api_call "QRDA Category 3 report"
    ...
    CDESC
    def patients
      log_api_call "Patients report", true
    ...
    def measures_spreadsheet
      log_api_call "Measure spreadsheet report"
      book = Spreadsheet::Workbook.new
      sheet = book.create_worksheet
      format = Spreadsheet::Format.new :weight => :bold
    ...
    CDESC
    def cat1
      log_api_call "QRDA Category 1 report", true

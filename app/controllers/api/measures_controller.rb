...
module Api
  class MeasuresController < ApplicationController
    ...
    def index
      log_api_call "View list of measures"
    ...
    def create
      ...
      log_api_call "Loaded measure"
      render json: ret_value
      rescue => e
        log_api_call "Failed to load measure, with error #{e.to_s}"
    ...
    def update_metadata
      ...
      log_api_call "Update measure metadata"
      render json:  measures,  each_serializer: HealthDataStandards::CQM::MeasureSerializer
      rescue => e
        log_api_call "Failed to update measure, with error #{e.to_s}"
        render text: e.to_s, status: 500
    end
    ...
    def finalize
      ...
      log_api_call "Finalize measure"
      render json: measure, serializer: HealthDataStandards::CQM::MeasureSerializer
      rescue => e
        log_api_call "Failed to finalize measure, with error #{e.to_s}"
        render text: e.to_s, status: 500
    end
